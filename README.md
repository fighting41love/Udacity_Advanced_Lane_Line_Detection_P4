...
I used a combination of color (HLS, HSV, Lab) and gradient thresholds to generate a binary image (thresholding steps at (Cell 622, 621, 620),).  Here's an example of my output for this step.  (note: this is not actually from one of the test images)
...
The histogram of the lane line is as follows:
...
![Lane Line](http://upload-images.jianshu.io/upload_images/2528310-db5e48bf73894b65.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/860)
```
